...
>
          ...
          <button style={styles.saveLocalBtn} onClick={handleSaveToLocal}>Save</button>
        </div>
    ...
    <div style={styles.modalCard}>
      ...
      <div style={styles.grid}>
        ...
        <div style={styles.inputGroup}>
          ...
          <input type="text" placeholder="Sub Category" value={formData.subCategory} onChange={(e) => setFormData({ ...formData, subCategory: e.target.value })} style={styles.input} />
        </div>
        <div style={styles.inputGroup}>
          <label>Amount</label>
      ...
      <div style={styles.inputGroup}>
        ...
        <textarea placeholder="Enter details" rows={3} value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} style={styles.textarea} />
      </div>
      ...
      <div style={{ marginTop: 10, marginBottom: 10 }}>
        ...
        <div style={styles.radioGroup}>
          <label style={styles.radioLabel}>
            <input type="radio" name="status" value="Paid" checked={formData.status === "Paid"} onChange={(e) => setFormData({ ...formData, status: e.target.value })} />
            <span style={{ color: "green", marginLeft: 5 }}>● Paid</span>
          </label>
          <label style={styles.radioLabel}>
            <input type="radio" name="status" value="Unpaid" checked={formData.status === "Unpaid"} onChange={(e) => setFormData({ ...formData, status: e.target.value })} />
      ...
      <div style={styles.modalFooter}>
        <button style={styles.cancelBtn} onClick={() => setShowForm(false)}>Discard</button>
        <button style={styles.saveBtn} onClick={handleAddExpense}>Save</button>
      </div>
    </div>
  </div>
)}
